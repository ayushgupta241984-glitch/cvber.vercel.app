        ...
        <div className="min-h-screen bg-black text-white pt-32 pb-20 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="card-gallery p-6 md:p-8 mb-16 flex gap-4">
                    <AlertTriangle className="w-5 h-5 text-white/60 shrink-0 mt-0.5" />
                    <p className="text-xs text-white/40 font-sans leading-relaxed">
                        <strong className="text-white">TL;DR:</strong> We provide the tools to help you protect your art, but you are responsible for how you use those tools and for ensuring you actually own the art you upload.
                    </p>
                </div>
                ...
                <section className="space-y-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 font-sans text-sm text-white/40">
                            <li className="flex gap-3"><span className="text-white/60 shrink-0">•</span> You are the <strong className="text-white">original creator</strong> or legal owner of the art you upload.</li>
                            <li className="flex gap-3"><span className="text-white/60 shrink-0">•</span> Your use of CVBER does not infringe upon the intellectual property of others.</li>
                            <li className="flex gap-3"><span className="text-white/60 shrink-0">•</span> You will not use the platform to generate <strong className="text-white">fraudulent certificates</strong> for art you do not own.</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-white/40 font-sans text-sm leading-relaxed">
                            Our C2PA certification service injects provenance metadata into your files. While we strive for industry compliance, we do not guarantee that the certificate will be recognized as legal proof of ownership in every jurisdiction. The certificate is a <strong className="text-white">technological aid</strong>, not a legal verdict.
                        </p>
                    </div>

                    <div className="card-gallery p-8 md:p-10">
                        <h2 className="text-3xl font-bold text-white mb-6">4. Limitations of Liability</h2>
                        <p className="text-white/40 font-sans text-sm italic mb-6">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={i} className="p-4 bg-[#050505] border-l-2 border-white/[0.2] font-sans text-xs text-white/40">
                                    {item}
                                </li>
                            ))}
                        </ul>
                    ...
                    <div className="pt-8 border-t border-white/[0.08] text-center">
                        <p className="text-white/40/40 font-sans text-xs">
                            Questions? Contact us at <a href="mailto:legal@cvber.app" className="text-white/60 hover:text-white/60Light transition-colors">legal@cvber.app</a>
                        </p>
                    </div>
                </section>
            </div>
