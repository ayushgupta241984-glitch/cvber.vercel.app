    ...
    return (
        <div className="min-h-screen bg-[#050505] flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#C9A962]/[0.03] rounded-full blur-[120px]" />
                <div className="relative z-10 px-16 max-w-lg">
                    <div className="w-12 h-12 rounded-2xl bg-[#C9A962]/10 border border-[#C9A962]/20 flex items-center justify-center mb-8">
                        <svg className="w-6 h-6 text-[#C9A962]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                    </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8 relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-[#C9A962]/[0.02] rounded-full blur-[100px] pointer-events-none" />

                <div className="w-full max-w-[380px] relative z-10">
                    {/* Mobile logo */}
                    <div className="lg:hidden text-center mb-10">
                        <Link href="/" className="inline-flex items-center gap-2.5">
                            <div className="w-8 h-8 rounded-xl bg-[#C9A962]/10 border border-[#C9A962]/20 flex items-center justify-center">
                                <svg className="w-4 h-4 text-[#C9A962]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/[0.03] border border-white/[0.06] rounded-xl pl-10 pr-4 py-3 text-white placeholder-white/15 focus:outline-none focus:border-[#C9A962]/40 focus:bg-white/[0.05] transition-all text-sm"
                        ...
                        <div>
                            <div className="flex justify-between mb-2">
                                ...
                                <a href="#" className="text-[10px] text-[#C9A962]/60 hover:text-[#C9A962] transition-colors uppercase tracking-wider font-semibold">Forgot?</a>
                            </div>
                            <div className="relative">
                        ...
                        <button
                            ...
                            disabled={loading}
                            suppressHydrationWarning
                            className="w-full py-3 bg-[#C9A962] hover:bg-[#d4b56d] text-black text-xs font-bold uppercase tracking-[0.15em] rounded-xl transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-40"
                        >
                            {loading ? (
                    ...
                    <p className="text-center text-white/20 mt-8 text-xs">
                        ...
                        <Link href="/register" className="text-[#C9A962]/70 hover:text-[#C9A962] font-semibold transition-colors">
                            Create one
                        </Link>
                    </p>
                </div>
    ...
    return (
        <Suspense fallback={
            <div className="min-h-screen bg-[#050505] flex items-center justify-center">
                <div className="w-5 h-5 border-2 border-white/10 border-t-[#C9A962] rounded-full animate-spin" />
            </div>
        }>
            <LoginForm />
        </Suspense>
