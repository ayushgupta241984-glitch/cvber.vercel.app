        ...
        <div className="min-h-screen bg-gradient-to-br from-cyber-darker via-cyber-dark to-purple-950/20 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="glass rounded-2xl p-8">
                    ...
                    {/* Google OAuth */}
                    <button className="w-full glass glass-hover rounded-xl py-3 text-white font-semibold flex items-center justify-center gap-3">
                    ...
                    <p className="text-center text-gray-400 mt-6">
                        ...
                        <Link href="/register" className="text-cyber-purple hover:text-cyber-blue transition-colors font-semibold">
                            Sign up
                        </Link>
                    </p>
                </div>
